        ...
        <div className="offcanvas offcanvas-end" tabIndex="-1" id="offcanvasNavbar" aria-labelledby="offcanvasNavbarLabel">
          ...
          <div className="offcanvas-body">
            <ul className="navbar-nav navbar-spacing justify-content-start flex-grow-1 pe-3 mt-2">
              ...
              <li className="nav-item">
                <Link className="nav-link nav-link-custom" to="/api/productos">Productos</Link>
              </li>
              <li className="nav-item">
            ...
            <form className="d-flex mt-2" role="search">
              <input className="form-control me-2" type="search" placeholder="Buscar" id="buscador" aria-label="Search"/>
